...
// @ts-ignore
import { Github, Gitlab, Linkedin, Mail, MapPin, Phone, Code, Briefcase, GraduationCap, User, ChevronUp } from 'lucide-react';
...
const ModernCardPortfolio = () => {
    ...
    const NavItem = ({ icon, text, section }) => (
        <button
            ...
            className={`flex items-center p-2 rounded-full transition-all duration-300 ${
                activeSection === section ? 'bg-purple-600 text-white' : 'bg-white text-purple-600 hover:bg-purple-100'
            }`}
        >
            {icon}
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            {/* Header */}
            <header className="bg-purple-600 text-white py-16 px-4">
                <div className="container mx-auto text-center">
                    <h1 className="text-4xl font-bold mb-2">Hashan Walauwatta</h1>
                    <p className="text-xl">Full Stack Developer</p>
                    <div className="flex justify-center mt-4 space-x-4">
                        <a href="https://gitlab.com/r123tharaka74" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-200">
                            <Gitlab size={24} />
                        </a>
                        <a href="https://github.com/hashan-lakshitha" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-200">
                            <Github size={24} />
                        </a>
                        <a href="http://www.linkedin.com/in/hashan-walauwatta-a45b332a1" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-200">
                            <Linkedin size={24} />
                        </a>
                    </div>
                </div>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <section id="experience" className="mb-16">
                    <div className="bg-white rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                        <h2 className="text-3xl font-bold mb-4 text-purple-600">Work Experience</h2>
                ...
                <section id="education" className="mb-16">
                    <div className="bg-white rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                        <h2 className="text-3xl font-bold mb-4 text-purple-600">Education</h2>
                        <div className="space-y-6">
                            <div className="border-l-4 border-purple-600 pl-4">
            ...
            {showScrollTop && (
                <button
                    onClick={scrollToTop}
                    className="fixed bottom-4 right-4 bg-purple-600 text-white p-2 rounded-full shadow-lg transition-all duration-300 hover:bg-purple-700"
                >
                    <ChevronUp size={24} />
                </button>
            )}
